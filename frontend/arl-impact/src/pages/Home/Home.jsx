    ...
    {/* Add Carousel  for Images in Homepage */}
      ...
      {/* <div className="envisionContainer">
        <h1 className="envisionTxt">
          ...
          <br />A community where people have the tools and resources to improve
          their lives and the lives of their family through{" "}
          <span className="spamWord fontdiner-swanky-regular">
            education and action.
          </span>
          <br />
          <br /> A community where businesses give back and people{" "}
          <span className="spamWord fontdiner-swanky-regular">donate</span>{" "}
          their timeand things they no longer use or need to help others. <br />
          <br />A community where{" "}
          <span className="spamWord fontdiner-swanky-regular">
            EVERYONE
          </span>{" "}
          plays a role and{" "}
          <span className="spamWord fontdiner-swanky-regular">EVERYONE</span>{" "}
      ...
      <iframe
        width="100%"
        height="315"
        src="https://www.youtube.com/embed/TmbWyO77M-8?si=Z9ysdWhNZy_go9Gy"
      ...
      ></iframe>
      <img
        className="adspaceimg"
        src="https://arlington.impactingcitiestx.com/wp-content/uploads/2025/11/Postcard-side-2-1024x732.jpg"
        alt=""
      />
    </>
  );
